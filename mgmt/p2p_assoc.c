...
/*----------------------------------------------------------------------------*/
/*!
 * @brief This function is used to compose Common Information Elements for P2P
				     ...
				     IN u8 *pucBuffer)
{
	...
	/* NOTE(Kevin): We copy the SSID from CONNECTION_SETTINGS for the case
	 * of Passive Scan and the target BSS didn't broadcast SSID on its
	 * Beacon Frame.
	 */
