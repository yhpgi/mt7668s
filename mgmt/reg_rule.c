...
#define REG_RULE_EXT(start, end, bw, gain, eirp, dfs_cac, reg_flags) \
	{ \
		...
		.freq_range.max_bandwidth_khz = MHZ_TO_KHZ(bw), .power_rule.max_eirp = DBM_TO_MBM(eirp), .flags = reg_flags, \
		.dfs_cac_ms = dfs_cac, \
	}
...
const struct mtk_regdomain *g_prRegRuleTable[] = {
	&my_regdom_us01, &my_regdom_us, &my_regdom_cn, &my_regdom_nl, &my_regdom_cz, &my_regdom_jp, &my_regdom_tr,
