...
const struct ieee80211_regdomain
	regdom_us01 = { .n_reg_rules = 6,
			.reg_rules = {
				...
				/* channels 56..64 */
				REG_RULE_LIGHT(5260 - 10, 5320 + 10, 40,
					       NL80211_RRF_DFS),
				/* channels 100..118 */
				REG_RULE_LIGHT(5500 - 10, 5590 + 10, 40,
					       NL80211_RRF_DFS),
				/* channels 132..140 */
				REG_RULE_LIGHT(5660 - 10, 5700 + 10, 40,
					       NL80211_RRF_DFS),
				/* channels 149..165 */
	...
	regdom_us = { .n_reg_rules = 5,
		      ...
		      .reg_rules = {
			      ...
			      REG_RULE_LIGHT(5260 - 10, 5320 + 10, 80,
					     NL80211_RRF_DFS | 0),
			      /* channels 100..140 */
			      REG_RULE_LIGHT(5500 - 10, 5720 + 10, 160,
					     NL80211_RRF_DFS),
			      /* channels 149..165 */
...
const struct mtk_regdomain my_regdom_us01 = { .country_code = "US01",
					      .prRegdRules = &regdom_us01 };

const struct mtk_regdomain my_regdom_us = { .country_code = "US",
					    .prRegdRules = &regdom_us };

const struct mtk_regdomain my_regdom_cn = { .country_code = "CN",
					    .prRegdRules = &regdom_cn };

const struct mtk_regdomain my_regdom_nl = { .country_code = "NL",
					    .prRegdRules = &regdom_cz_nl };

const struct mtk_regdomain my_regdom_cz = { .country_code = "CZ",
					    .prRegdRules = &regdom_cz_nl };

const struct mtk_regdomain my_regdom_jp = { .country_code = "JP",
					    .prRegdRules = &regdom_jp };

const struct mtk_regdomain my_regdom_tr = { .country_code = "TR",
