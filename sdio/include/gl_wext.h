...
/* for IE Searching */
extern u8 wextSrchDesiredWPAIE(IN u8 *pucIEStart,
			       IN s32 i4TotalIeLen,
			       IN u8 ucDesiredElemId,
			       OUT u8 **ppucDesiredIE);

#if CFG_SUPPORT_WPS
extern u8 wextSrchDesiredWPSIE(IN u8 *pucIEStart,
			       IN s32 i4TotalIeLen,
			       IN u8 ucDesiredElemId,
			       OUT u8 **ppucDesiredIE);
#endif
...
#define IW_AUTH_ROAMING_DISABLE	\
	1 /* user space program used for roaming control */
...
int wext_set_rate(IN struct net_device *prNetDev,
...
u8 wextSrchDesiredWPAIE(IN u8 *pucIEStart,
			IN s32 i4TotalIeLen,
			IN u8 ucDesiredElemId,
			OUT u8 **ppucDesiredIE);

#if CFG_SUPPORT_WPS
u8 wextSrchDesiredWPSIE(IN u8 *pucIEStart,
			IN s32 i4TotalIeLen,
			IN u8 ucDesiredElemId,
			OUT u8 **ppucDesiredIE);
#endif

u8 wextSrchDesiredWAPIIE(IN u8 *pucIEStart,
			 IN s32 i4TotalIeLen,
			 OUT u8 **ppucDesiredIE);
