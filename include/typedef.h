...
typedef u32 WLAN_STATUS, *P_WLAN_STATUS;
...
/* Type definition for STA_RECORD_T structure to handle the connectivity and
 * packet reception for a particular STA.
 */
