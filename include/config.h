...
#define CFG_SUPPORT_SPEC_MGMT \
	1 /* Spectrum Management (802.11h): TPC and DFS \
	   */
#else
#define CFG_SUPPORT_QUIET			0 /* Quiet (802.11h) */
#define CFG_SUPPORT_SPEC_MGMT \
	0 /* Spectrum Management (802.11h): TPC and DFS \
	   */
#endif
...
#endif
#define CFG_TCP_IP_CHKSUM_OFFLOAD_NDIS_60 \
	0 /* !< 1: Enable TCP/IP header checksum offload */
/* 0: Disable */
...
/* 0: Disable */
#else
#define CFG_SDIO_PATHRU_MODE \
	0 /*!< 0: Always disable if WINDOWS_CE is not defined */
#endif
...
#define CFG_DRV_OWN_VERSION \
	((u16)((NIC_DRIVER_MAJOR_VERSION << 8) | (NIC_DRIVER_MINOR_VERSION)))
#define CFG_DRV_PEER_VERSION			    ((u16)0x0000)
...
#define CFG_RX_MAX_PKT_NUM					   \
	((CFG_NUM_OF_RX0_HIF_DESC + CFG_NUM_OF_RX1_HIF_DESC) * 3 + \
...
#define CFG_RX_MAX_PKT_SIZE			    (28 + 2312 + \
						     12 /*HIF_RX_HEADER_T*/ )
...
#define CFG_MAX_COMMON_IE_BUF_LEN		    ((1500 * \
						      CFG_MAX_NUM_BSS_LIST) / 3)
 ...
 */
#define MAX_CHN_NUM \
	39 /* ARRAY_SIZE(mtk_5ghz_channels) + ARRAY_SIZE(mtk_2ghz_channels) */
#define MAX_2G_BAND_CHN_NUM			    14
#define MAX_5G_BAND_CHN_NUM			    (MAX_CHN_NUM - \
						     MAX_2G_BAND_CHN_NUM)
