...
#define QUEUE_IS_EMPTY(prQueue)	\
	(((P_QUE_T)(prQueue))->prHead == (P_QUE_ENTRY_T)NULL)
...
#define QUEUE_GET_SIZE(prQueue)		      (((prQueue)->u4NumElem)
...
/* NOTE: We assume the queue entry located at the beginning of "prQueueEntry
 * Type", so that we can cast the queue entry to other data type without doubts.
