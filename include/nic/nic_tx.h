...
#define HAL_MAC_TX_DESC_SET_ETHER_TYPE_OFFSET(_prHwMacTxDesc, _ucEtherTypeOffset) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->ucEtherOffset), ((UINT_8)_ucEtherTypeOffset), TX_DESC_ETHER_TYPE_OFFSET_MASK, \
...
#define HAL_MAC_TX_DESC_GET_TXD_EXTEND_LENGTH(_prHwMacTxDesc) \
	TX_DESC_GET_FIELD( \
			(_prHwMacTxDesc)->ucHeaderPadding, TX_DESC_TXD_EXTEND_LENGTH_MASK, TX_DESC_TXD_EXTEND_LENGTH_OFFSET)
#define HAL_MAC_TX_DESC_SET_TXD_EXTEND_LENGTH(_prHwMacTxDesc, _ucHdrPadding) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->ucHeaderPadding), ((UINT_8)_ucHdrPadding), TX_DESC_TXD_EXTEND_LENGTH_MASK, \
...
#define HAL_MAC_TX_DESC_SET_OWN_MAC_INDEX(_prHwMacTxDesc, _ucOwnMacIdx) \
	TX_DESC_SET_FIELD( \
			((_prHwMacTxDesc)->ucOwnMAC), ((UINT_8)_ucOwnMacIdx), TX_DESC_OWN_MAC_MASK, TX_DESC_OWN_MAC_OFFSET)
...
#define HAL_MAC_TX_DESC_SET_SUB_TYPE(_prHwMacTxDesc, _ucSubType) \
	TX_DESC_SET_FIELD( \
			((_prHwMacTxDesc)->ucType_SubType), ((UINT_8)_ucSubType), TX_DESC_SUB_TYPE_MASK, TX_DESC_SUB_TYPE_OFFSET)
...
#define HAL_MAC_TX_DESC_GET_REMAINING_TX_COUNT(_prHwMacTxDesc) \
	TX_DESC_GET_FIELD( \
			(_prHwMacTxDesc)->u2TxCountLimit, TX_DESC_REMAINING_TX_COUNT_MASK, TX_DESC_REMAINING_TX_COUNT_OFFSET)
#define HAL_MAC_TX_DESC_SET_REMAINING_TX_COUNT(_prHwMacTxDesc, _ucTxCountLimit) \
	TX_DESC_SET_FIELD(((_prHwMacTxDesc)->u2TxCountLimit), ((UINT_8)_ucTxCountLimit), TX_DESC_REMAINING_TX_COUNT_MASK, \
...
#define HAL_MAC_TX_DESC_SET_HW_RESERVED(_prHwMacTxDesc, _ucHwReserved) \
	TX_DESC_SET_FIELD( \
			((_prHwMacTxDesc)->u2SN), ((UINT_8)_ucHwReserved), TX_DESC_HW_RESERVED_MASK, TX_DESC_HW_RESERVED_OFFSET)
...
#define HAL_MAC_TX_DESC_SET_FR_ANTENNA_ID(_prHwMacTxDesc, _ucAntId) \
	TX_DESC_SET_FIELD( \
			((_prHwMacTxDesc)->u2AntID), ((UINT_8)_ucAntId), TX_DESC_ANTENNA_INDEX_MASK, TX_DESC_ANTENNA_INDEX_OFFSET)
...
VOID nicTxSetDataPacket(IN P_ADAPTER_T prAdapter, IN P_MSDU_INFO_T prMsduInfo, IN UINT_8 ucBssIndex,
		IN UINT_8 ucStaRecIndex, IN UINT_8 ucMacHeaderLength, IN UINT_16 u2FrameLength,
		IN PFN_TX_DONE_HANDLER pfTxDoneHandler, IN UINT_8 ucRateMode, IN ENUM_TX_PACKET_SRC_T eSrc, IN UINT_8 ucTID,
		IN BOOLEAN fgIs802_11Frame, IN BOOLEAN fgIs1xFrame);
