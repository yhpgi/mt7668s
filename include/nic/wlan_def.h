...
#define RATE_CCK_1M_LONG                   (TX_MODE_CCK | \
                                            PHY_RATE_1M)
#define RATE_CCK_2M_LONG                   (TX_MODE_CCK | \
                                            PHY_RATE_2M)
#define RATE_CCK_5_5M_LONG                 (TX_MODE_CCK | \
                                            PHY_RATE_5_5M)
#define RATE_CCK_11M_LONG                  (TX_MODE_CCK | \
                                            PHY_RATE_11M)
#define RATE_CCK_2M_SHORT                  (TX_MODE_CCK | \
                                            PHY_RATE_2M | \
                                            RATE_CCK_SHORT_PREAMBLE)
...
#define RATE_OFDM_6M                       (TX_MODE_OFDM | \
                                            PHY_RATE_6M)
#define RATE_OFDM_9M                       (TX_MODE_OFDM | \
                                            PHY_RATE_9M)
#define RATE_OFDM_12M                      (TX_MODE_OFDM | \
                                            PHY_RATE_12M)
#define RATE_OFDM_18M                      (TX_MODE_OFDM | \
                                            PHY_RATE_18M)
#define RATE_OFDM_24M                      (TX_MODE_OFDM | \
                                            PHY_RATE_24M)
#define RATE_OFDM_36M                      (TX_MODE_OFDM | \
                                            PHY_RATE_36M)
#define RATE_OFDM_48M                      (TX_MODE_OFDM | \
                                            PHY_RATE_48M)
#define RATE_OFDM_54M                      (TX_MODE_OFDM | \
                                            PHY_RATE_54M)

#define RATE_MM_MCS_0                      (TX_MODE_HT_MM | \
                                            PHY_RATE_MCS0)
#define RATE_MM_MCS_1                      (TX_MODE_HT_MM | \
                                            PHY_RATE_MCS1)
#define RATE_MM_MCS_2                      (TX_MODE_HT_MM | \
                                            PHY_RATE_MCS2)
#define RATE_MM_MCS_3                      (TX_MODE_HT_MM | \
                                            PHY_RATE_MCS3)
#define RATE_MM_MCS_4                      (TX_MODE_HT_MM | \
                                            PHY_RATE_MCS4)
#define RATE_MM_MCS_5                      (TX_MODE_HT_MM | \
                                            PHY_RATE_MCS5)
#define RATE_MM_MCS_6                      (TX_MODE_HT_MM | \
                                            PHY_RATE_MCS6)
#define RATE_MM_MCS_7                      (TX_MODE_HT_MM | \
                                            PHY_RATE_MCS7)
#define RATE_MM_MCS_32                     (TX_MODE_HT_MM | \
                                            PHY_RATE_MCS32)

#define RATE_GF_MCS_0                      (TX_MODE_HT_GF | \
                                            PHY_RATE_MCS0)
#define RATE_GF_MCS_1                      (TX_MODE_HT_GF | \
                                            PHY_RATE_MCS1)
#define RATE_GF_MCS_2                      (TX_MODE_HT_GF | \
                                            PHY_RATE_MCS2)
#define RATE_GF_MCS_3                      (TX_MODE_HT_GF | \
                                            PHY_RATE_MCS3)
#define RATE_GF_MCS_4                      (TX_MODE_HT_GF | \
                                            PHY_RATE_MCS4)
#define RATE_GF_MCS_5                      (TX_MODE_HT_GF | \
                                            PHY_RATE_MCS5)
#define RATE_GF_MCS_6                      (TX_MODE_HT_GF | \
                                            PHY_RATE_MCS6)
#define RATE_GF_MCS_7                      (TX_MODE_HT_GF | \
                                            PHY_RATE_MCS7)
#define RATE_GF_MCS_32                     (TX_MODE_HT_GF | \
                                            PHY_RATE_MCS32)

#define RATE_VHT_MCS_0                     (TX_MODE_VHT | \
                                            PHY_RATE_MCS0)
#define RATE_VHT_MCS_1                     (TX_MODE_VHT | \
                                            PHY_RATE_MCS1)
#define RATE_VHT_MCS_2                     (TX_MODE_VHT | \
                                            PHY_RATE_MCS2)
#define RATE_VHT_MCS_3                     (TX_MODE_VHT | \
                                            PHY_RATE_MCS3)
#define RATE_VHT_MCS_4                     (TX_MODE_VHT | \
                                            PHY_RATE_MCS4)
#define RATE_VHT_MCS_5                     (TX_MODE_VHT | \
                                            PHY_RATE_MCS5)
#define RATE_VHT_MCS_6                     (TX_MODE_VHT | \
                                            PHY_RATE_MCS6)
#define RATE_VHT_MCS_7                     (TX_MODE_VHT | \
                                            PHY_RATE_MCS7)
#define RATE_VHT_MCS_8                     (TX_MODE_VHT | \
                                            PHY_RATE_MCS8)
#define RATE_VHT_MCS_9                     (TX_MODE_VHT | \
                                            PHY_RATE_MCS9)
...
#define PHY_TYPE_BIT_HR_DSSS \
    BIT(PHY_TYPE_HR_DSSS_INDEX)  /* HR/DSSS PHY (clause 18) */
#define PHY_TYPE_BIT_ERP                   BIT(PHY_TYPE_ERP_INDEX)  /* ERP PHY (clause 19) */
#define PHY_TYPE_BIT_OFDM \
    BIT(PHY_TYPE_OFDM_INDEX)  /* OFDM 5 GHz PHY (clause 17) */
...
#define PHY_TYPE_SET_802_11ABGN                                    \
    (PHY_TYPE_BIT_OFDM | PHY_TYPE_BIT_HR_DSSS | PHY_TYPE_BIT_ERP | \
     PHY_TYPE_BIT_HT)

#define PHY_TYPE_SET_802_11BGN \
    (PHY_TYPE_BIT_HR_DSSS | PHY_TYPE_BIT_ERP | PHY_TYPE_BIT_HT)
...
#define PHY_TYPE_SET_802_11ANAC \
    (PHY_TYPE_BIT_OFDM | PHY_TYPE_BIT_HT | PHY_TYPE_BIT_VHT)
...
#define RATE_SET_BIT_HT_PHY \
    BIT(RATE_HT_PHY_SW_INDEX)  /* Bit 14: BSS Selector \
                                */

/* Rate set definitions */
#define RATE_SET_HR_DSSS                                     \
    (RATE_SET_BIT_1M | RATE_SET_BIT_2M | RATE_SET_BIT_5_5M | \
     RATE_SET_BIT_11M)

#define RATE_SET_ERP                                          \
    (RATE_SET_BIT_1M | RATE_SET_BIT_2M | RATE_SET_BIT_5_5M |  \
     RATE_SET_BIT_11M | RATE_SET_BIT_6M | RATE_SET_BIT_9M |   \
     RATE_SET_BIT_12M | RATE_SET_BIT_18M | RATE_SET_BIT_24M | \
     RATE_SET_BIT_36M | RATE_SET_BIT_48M | RATE_SET_BIT_54M)

#define RATE_SET_ERP_P2P                                      \
    (RATE_SET_BIT_6M | RATE_SET_BIT_9M | RATE_SET_BIT_12M |   \
     RATE_SET_BIT_18M | RATE_SET_BIT_24M | RATE_SET_BIT_36M | \
...
#define BASIC_RATE_SET_HR_DSSS_ERP                           \
    (RATE_SET_BIT_1M | RATE_SET_BIT_2M | RATE_SET_BIT_5_5M | \
     RATE_SET_BIT_11M)

#define BASIC_RATE_SET_ERP                                   \
    (RATE_SET_BIT_1M | RATE_SET_BIT_2M | RATE_SET_BIT_5_5M | \
     RATE_SET_BIT_11M | RATE_SET_BIT_6M | RATE_SET_BIT_12M | \
     RATE_SET_BIT_24M)

#define BASIC_RATE_SET_OFDM \
    (RATE_SET_BIT_6M | RATE_SET_BIT_12M | RATE_SET_BIT_24M)

#define BASIC_RATE_SET_ERP_P2P \
    (RATE_SET_BIT_6M | RATE_SET_BIT_12M | RATE_SET_BIT_24M)
...
#define INITIAL_RATE_SET_RCPI_60                             \
    (RATE_SET_BIT_1M | RATE_SET_BIT_2M | RATE_SET_BIT_5_5M | \
     RATE_SET_BIT_11M | RATE_SET_BIT_6M)
...
#define MAX_ASSOC_ID \
    (CFG_STA_REC_NUM)  /* Available AID: 1 ~ 20(STA_REC_NUM) \
                        */

#define MAX_DEAUTH_INFO_COUNT             4  /* NOTE(Kevin): Used in auth.c */
#define MIN_DEAUTH_INTERVAL_MSEC \
    500  /* The minimum interval if continuously send Deauth Frame */

/* Authentication Type */
#define AUTH_TYPE_OPEN_SYSTEM             BIT( \
        AUTH_ALGORITHM_NUM_OPEN_SYSTEM)
#define AUTH_TYPE_SHARED_KEY              BIT( \
...
typedef u16 PHY_TYPE, *P_PHY_TYPE;
typedef u8 RCPI, *P_RCPI;
typedef u8 ALC_VAL, *P_ALC_VAL;
...
typedef enum _ENUM_PREMABLE_OPTION_T {
    PREAMBLE_DEFAULT_LONG_NONE = 0,  /* long for PHY_TYPE_HR_DSSS, NONE for
                                      * PHY_TYPE_OFDM */
    PREAMBLE_OPTION_SHORT,  /* SHORT mandatory for PHY_TYPE_ERP, SHORT option
...
struct POWER_LIMIT {
    u8 ucCentralCh;
    u8 tx_pwr_dsss[PWR_DSSS_NUM];  /*unit: 0.5 dbm*/
    u8 tx_pwr_ofdm[PWR_OFDM_NUM];  /*unit: 0.5 dbm*/
    u8 tx_pwr_ht20[PWR_HT_NUM];  /*unit: 0.5 dbm*/
    u8 tx_pwr_ht40[PWR_HT_NUM];  /*unit: 0.5 dbm*/
    u8 tx_pwr_vht20[PWR_VHT20_NUM];  /*unit: 0.5 dbm*/
    u8 tx_pwr_vht_OFST[PWR_VHT_OFST_NUM];  /*unit: 0.5 dbm*/
};
...
typedef struct _RF_CHANNEL_INFO_T {
    ENUM_BAND_T eBand;
    u32 u4CenterFreq1;  /* To record Channel Center Frequency Segment 0 (MHz)
                         * from CFG80211 */
    u32 u4CenterFreq2;  /* To record Channel Center Frequency Segment 1 (MHz)
                         * from CFG80211 */
    u16 u2PriChnlFreq;  /* To record primary channel frequency (MHz) from
                         * CFG80211 */
    u8 ucChnlBw;  /* To record channel bandwidth from CFG80211 */
    u8 ucChannelNum;
#if (CFG_SUPPORT_DFS_MASTER == 1)
    u32 u4ChnlDfsState;  /* Channel DFS State */
#endif
...
typedef void (*PFN_VERIFY_IE_FUNC)(P_ADAPTER_T, P_SW_RFB_T, P_IE_HDR_T, u16 *);
typedef u32 (*PFN_CALCULATE_VAR_IE_LEN_FUNC)(P_ADAPTER_T, u8, P_STA_RECORD_T);

typedef struct _APPEND_IE_ENTRY_T {
    u16 u2EstimatedIELen;
    PFN_APPEND_IE_FUNC pfnAppendIE;
} APPEND_IE_ENTRY_T, *P_APPEND_IE_ENTRY_T;

typedef struct _APPEND_VAR_IE_ENTRY_T {
    u16 u2EstimatedFixedIELen;  /* For Fixed Length */
...
typedef enum _ENUM_PARAM_PREAMBLE_TYPE_T {
    ...
    PREAMBLE_TYPE_SHORT,
    PREAMBLE_TYPE_AUTO  /*!< Try preamble short first, if fail tray preamble
                         * long. */
...
typedef enum _ENUM_PARAM_PHY_CONFIG_T {
    PHY_CONFIG_802_11ABG = 0,  /*!< Can associated with 802.11abg AP but
                                * without n capability, Scan dual band.
                                **/
    PHY_CONFIG_802_11BG,  /*!< Can associated with 802_11bg AP, Scan single
                           * band and not report 5G BSSs.
                           **/
    PHY_CONFIG_802_11G,  /*!< Can associated with 802_11g only AP, Scan
                          * single band and not report 5G BSSs. */
    PHY_CONFIG_802_11A,  /*!< Can associated with 802_11a only AP, Scan
                          * single band and not report 2.4G BSSs. */
    PHY_CONFIG_802_11B,  /*!< Can associated with 802_11b only AP, Scan
                          * single band and not report 5G BSSs. */
    PHY_CONFIG_802_11ABGN,  /*!< Can associated with 802.11abgn AP, Scan dual
                             * band. */
    PHY_CONFIG_802_11BGN,  /*!< Can associated with 802_11bgn AP, Scan single
                            * band and not report 5G BSSs.
                            **/
    PHY_CONFIG_802_11AN,  /*!< Can associated with 802_11an AP, Scan single
                           * band and not report 2.4G BSSs.
                           **/
    PHY_CONFIG_802_11GN,  /*!< Can associated with 802_11gn AP, Scan single
                           * band and not report 5G BSSs.
                           **/
    PHY_CONFIG_802_11AC,
...
typedef enum _ENUM_PARAM_AP_MODE_T {
    AP_MODE_11B = 0,  /*!< Create 11b BSS if we support 802.11abg/802.11bg.
                       */
    AP_MODE_MIXED_11BG,  /*!< Create 11bg mixed BSS if we support
                          * 802.11abg/802.11bg/802.11g. */
    AP_MODE_11G,  /*!< Create 11g only BSS if we support
                   * 802.11abg/802.11bg/802.11g. */
    AP_MODE_11G_P2P,  /*!< Create 11g only BSS for P2P if we support
                       * 802.11abg/802.11bg/802.11g. */
...
/* Masks for determining the Network Type or the Station Role, given the
 * ENUM_STA_TYPE_T */
...
#define IS_STA_P2P_TYPE(_prStaRec)    ((_prStaRec->eStaType) & \
                                       STA_TYPE_P2P_MASK)
#define IS_STA_BOW_TYPE(_prStaRec)    ((_prStaRec->eStaType) & \
                                       STA_TYPE_BOW_MASK)
#define IS_ADHOC_STA( \
        _prStaRec)        ((_prStaRec->eStaType) & STA_TYPE_ADHOC_MASK)
#define IS_CLIENT_STA(                             \
        _prStaRec)        ((_prStaRec->eStaType) & \
                           STA_TYPE_CLIENT_MASK)
#define IS_AP_STA(_prStaRec)          ((_prStaRec->eStaType) & STA_TYPE_AP_MASK)
#define IS_DLS_STA(_prStaRec)         ((_prStaRec->eStaType) & \
                                       STA_TYPE_DLS_MASK)

/* The ENUM_STA_TYPE_T accounts for ENUM_NETWORK_TYPE_T and
 * ENUM_STA_ROLE_INDEX_T. It is a merged version of Network Type and STA Role.
 */
...
typedef struct _RSN_INFO_T {
    ...
    u32 u4PairwiseKeyCipherSuiteCount;
    u32 au4PairwiseKeyCipherSuite[MAX_NUM_SUPPORTED_CIPHER_SUITES];
    u32 u4AuthKeyMgtSuiteCount;
    u32 au4AuthKeyMgtSuite[MAX_NUM_SUPPORTED_AKM_SUITES];
    u16 u2RsnCap;
    u8 fgRsnCapPresent;
    u16 u2PmkidCnt;
    u8 aucPmkidList[MAX_NUM_SUPPORTED_PMKID * RSN_PMKID_LEN];
    u32 u4GroupMgmtKeyCipherSuite;
}  /*__KAL_ATTRIB_PACKED__*/ RSN_INFO_T, *P_RSN_INFO_T;

#define MAX_NUM_SUPPORTED_WAPI_AKM_SUITES \
    1  /* max number of supported AKM suites */
#define MAX_NUM_SUPPORTED_WAPI_CIPHER_SUITES \
    1  /* max number of supported cipher suites */
...
typedef struct _WAPI_INFO_T {
    ...
    u16 u2Version;
    u32 u4AuthKeyMgtSuiteCount;
    u32 au4AuthKeyMgtSuite[MAX_NUM_SUPPORTED_WAPI_AKM_SUITES];
    u32 u4PairwiseKeyCipherSuiteCount;
    u32 au4PairwiseKeyCipherSuite[MAX_NUM_SUPPORTED_WAPI_CIPHER_SUITES];
    u32 u4GroupKeyCipherSuite;
    u16 u2WapiCap;
    u16 u2Bkid;
    u8 aucBkid[1][16];
...
typedef struct _P2P_DEVICE_DESC_T {
    ...
    u8 aucInterfaceAddr[MAC_ADDR_LEN];  /* Interface Address. */
    u8 ucDeviceCapabilityBitmap;
    u8 ucGroupCapabilityBitmap;
    u16 u2ConfigMethod;  /* Configure Method support. */
    P2P_DEVICE_TYPE_T rPriDevType;
    u8 ucSecDevTypeNum;
    P2P_DEVICE_TYPE_T
        arSecDevType[8];  /* Reference to P2P_GC_MAX_CACHED_SEC_DEV_TYPE_COUNT */
    u16 u2NameLength;
    u8 aucName[32];  /* Reference to WPS_ATTRI_MAX_LEN_DEVICE_NAME */
...
#define WLAN_GET_FIELD_16(_memAddr_p, _value_p)                    \
    {                                                              \
        u8 *__cp = (u8 *)(_memAddr_p);                             \
        *(u16 *)(_value_p) = ((u16)__cp[0]) | ((u16)__cp[1] << 8); \
    }

#define WLAN_GET_FIELD_BE16(_memAddr_p, _value_p)                  \
    {                                                              \
        u8 *__cp = (u8 *)(_memAddr_p);                             \
        *(u16 *)(_value_p) = ((u16)__cp[0] << 8) | ((u16)__cp[1]); \
    }

#define WLAN_GET_FIELD_32(_memAddr_p, _value_p)                     \
    {                                                               \
        u8 *__cp = (u8 *)(_memAddr_p);                              \
        *(u32 *)(_value_p) = ((u32)__cp[0]) | ((u32)__cp[1] << 8) | \
                             ((u32)__cp[2] << 16) |                 \
                             ((u32)__cp[3] << 24);                  \
    }
...
#define WLAN_GET_FIELD_BE32(_memAddr_p, _value_p)                  \
    {                                                              \
        u8 *__cp = (u8 *)(_memAddr_p);                             \
        *(u32 *)(_value_p) = ((u32)__cp[0] << 24) |                \
                             ((u32)__cp[1] << 16) |                \
                             ((u32)__cp[2] << 8) | ((u32)__cp[3]); \
    }
...
#define WLAN_GET_FIELD_64(_memAddr_p, _value_p)           \
    {                                                     \
        u8 *__cp = (u8 *)(_memAddr_p);                    \
        *(u64 *)(_value_p) =                              \
            ((u64)__cp[0]) | ((u64)__cp[1] << 8) |        \
            ((u64)__cp[2] << 16) | ((u64)__cp[3] << 24) | \
            ((u64)__cp[4] << 32) | ((u64)__cp[5] << 40) | \
            ((u64)__cp[6] << 48) | ((u64)__cp[7] << 56);  \
    }
