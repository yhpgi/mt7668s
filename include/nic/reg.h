...
#ifndef _MT7668S_REG_H
#define _MT7668S_REG_H
...
#define WHIER_DEFAULT 				(WHIER_RX0_DONE_INT_EN \
	| WHIER_RX1_DONE_INT_EN | WHIER_TX_DONE_INT_EN | WHIER_ABNORMAL_INT_EN | WHIER_D2H_SW_INT)
...
/* WLAN Software Interrupt Control Register */
#define MCR_WSICR 				0x0024 
#define WSICR_H2D_SW_INT_SET 	BITS(16, 31)

#define MCR_WTDR1		0x0034 /* WLAN TX Data Register 1 */
#define MCR_WRDR0 		0x0050 /* WLAN RX Data Register 0 */
#define MCR_WRDR1 		0x0054 /* WLAN RX Data Register 1 */

#define MCR_H2DSM0R 	0x0070 /* Host to Device Send Mailbox 0 Register */
#define MCR_H2DSM1R 	0x0074 /* Host to Device Send Mailbox 1 Register */
#define MCR_D2HRM0R 	0x0078 /* Device to Host Receive Mailbox 0 Register */
#define MCR_D2HRM1R 	0x007c /* Device to Host Receive Mailbox 1 Register */
...
#define MCR_WTMDR 		0x00b0 /* Test Mode Data Port */
...
#define MCR_WTMDPCR0 	0x00b8 /* Test Mode Data Pattern Control Register #0 */
#define MCR_WTMDPCR1 	0x00bc /* Test Mode Data Pattern Control Register #1 */
#define MCR_WPLRCR		0x00d4 /* WLAN Packet Length Report Control Register */
#define MCR_WSR 		0x00D8 /* WLAN Snapshot Register */

#define MCR_CLKIOCR 	0x0100 /* Clock Pad Macro IO Control Register */
#define MCR_CMDIOCR 	0x0104 /* Command Pad Macro IO Control Register */

#define MCR_DAT0IOCR 	0x0108 /* Data 0 Pad Macro IO Control Register */
#define MCR_DAT1IOCR 	0x010C /* Data 1 Pad Macro IO Control Register */
#define MCR_DAT2IOCR 	0x0110 /* Data 2 Pad Macro IO Control Register */
#define MCR_DAT3IOCR 	0x0114 /* Data 3 Pad Macro IO Control Register */

#define MCR_CLKDLYCR 	0x0118 /* Clock Pad Macro Delay Chain Control Register */

#define MCR_CMDDLYCR 	0x011C /* Command Pad Macro Delay Chain Control Register */
#define MCR_ODATDLYCR 	0x0120 /* SDIO Output Data Delay Chain Control Register */
#define MCR_IDATDLYCR1 	0x0124 /* SDIO Input Data Delay Chain Control Register 1 */
#define MCR_IDATDLYCR2 	0x0128 /* SDIO Input Data Delay Chain Control Register 2 */

#define MCR_ILCHCR 		0x012C /* SDIO Input Data Latch Time Control Register */

#define MCR_WTQCR0 		0x0130 /* WLAN TXQ Count Register 0 */
#define MCR_WTQCR1 		0x0134 /* WLAN TXQ Count Register 1 */
#define MCR_WTQCR2 		0x0138 /* WLAN TXQ Count Register 2 */
#define MCR_WTQCR3 		0x013C /* WLAN TXQ Count Register 3 */
#define MCR_WTQCR4 		0x0140 /* WLAN TXQ Count Register 4 */
#define MCR_WTQCR5 		0x0144 /* WLAN TXQ Count Register 5 */
#define MCR_WTQCR6 		0x0148 /* WLAN TXQ Count Register 6 */
#define MCR_WTQCR7 		0x014C /* WLAN TXQ Count Register 7 */

#define MCR_SWPCDBGR 	0x0154 /* WLAN/Common PC value Debug registre */
