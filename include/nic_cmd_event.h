...
enum CSI_CONTROL_MODE_T { CSI_CONTROL_MODE_STOP, CSI_CONTROL_MODE_START, CSI_CONTROL_MODE_NUM };

enum ENUM_RTT_ROLE_T { RTT_ROLE_RECEIVING = 0, RTT_ROLE_SENDING, RTT_ROLE_NUM };

enum ENUM_RTT_FRAME_TYPE_T { RTT_FRAME_TYPE_BEACON, RTT_FRAME_TYPE_QOS_DATA, RTT_FRAME_TYPE_NUM };
