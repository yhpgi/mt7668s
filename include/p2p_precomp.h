...
/*! \file   p2p_precomp.h
 *    \brief  Collection of most compiler flags for p2p driver are described
 * here.
 *
 *    In this file we collect all compiler flags and detail the p2p driver
 * behavior if enable/disable such switch or adjust numeric parameters.
 */
